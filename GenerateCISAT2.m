...
if index == 5
    params5(count,:) = FittingforCI(dd,index);
...
if index == 6
    params6(count,:) = FittingforCI(dd,index);
...
if index == 7
    params7(count,:) = FittingforCI(dd,index);
...
if index == 8
    params8(count,:) = FittingforCI(dd,index);
...
save('Fits5.mat','Fits5')
save('Fits6.mat','Fits6')
save('Fits7.mat','Fits7')
save('Fits8.mat','Fits8')

save('params5.mat','params5')
save('params6.mat','params6')
save('params7.mat','params7')
save('params8.mat','params8')
...
save('SData5.mat','SData5')
save('SData6.mat','SData6')
save('SData7.mat','SData7')
save('SData8.mat','SData8')
save('SAT2means.mat','SAT2means')
save('SAT2devs.mat','SAT2devs')
save('pHats5.mat','pHats5')
save('pCImu5.mat','pCImu5')
save('pCIsig5.mat','pCIsig5')
save('pHats6.mat','pHats6')
save('pCImu6.mat','pCImu6')
save('pCIsig6.mat','pCIsig6')
save('pHats7.mat','pHats7')
save('pCImu7.mat','pCImu7')
save('pCIsig7.mat','pCIsig7')
save('pHats8.mat','pHats8')
save('pCImu8.mat','pCImu8')
save('pCIsig8.mat','pCIsig8')
end
