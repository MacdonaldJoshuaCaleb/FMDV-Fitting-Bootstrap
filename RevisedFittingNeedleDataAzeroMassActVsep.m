function [] = RevisedFittingNeedleDataAzeroMassActVsep
close all
% turn figure display on  or off
set(0,'DefaultFigureVisible','on')
% import and organize data
xs = readtable('SAADataNeedle.csv');
...
%    pvfit = fits(2*length(tt)+1:end);
    ...
    str2= strcat('ID',num2str(IDs(j)),groups(j),'SAA')
%    length(tt(1:end-1))
%    length(xfit)
   figure
   hold on
...
save('pfitsNeedleFinal.mat','pfitsNeedleFinal')
save('maxViralNeedleFinal.mat','maxViralNeedle')
save('cumviralNeedleFinal.mat','cumviralNeedle')
%save('VTCFinal.mat','VTC')
save('xfitsNFinal.mat','xfitsN')
save('sfitsNFinal.mat','sfitsN')
save('pvfitsNFinal.mat','pvfitsN')
