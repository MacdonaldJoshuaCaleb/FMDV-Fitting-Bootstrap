...
load('Fits9Hapto.mat');
load('Fits11Hapto.mat');
load('Fits12Hapto.mat');
%load('Fits8.mat')
...
for j = 1:10000
 RE9(j,:) = abs(params(9,1:end-1)-params9(j,:))./params(9,1:end-1);
end
ARE9 = (sum(RE9)/10000)*100;
array2table(ARE9)

for j = 1:10000
 RE11(j,:) = abs(params(11,1:end-1)-params11(j,:))./params(11,1:end-1);
end
ARE11= (sum(RE11)/10000)*100;
array2table(ARE11)

for j = 1:10000
 RE12(j,:) = abs(params(12,1:end-1)-params12(j,:))./params(12,1:end-1);
end
