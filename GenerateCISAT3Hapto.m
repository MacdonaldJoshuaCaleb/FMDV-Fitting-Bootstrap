...
% if index == 10
%     params10(count,:) = FittingforCIHapto(dd,index);
...
% RE10(count,:) = abs(params10(count,:)-params(6,:))./params(6,:);
...
%save('SData10Hapto.mat','SData10')
save('SData11Hapto.mat','SData11')
save('SData12Hapto.mat','SData12')
save('SAT3meansHapto.mat','SAT3means')
save('SAT3devsHapto.mat','SAT3devs')
save('pHats9Hapto.mat','pHats9')
save('pCImu9Hapto.mat','pCImu9')
save('pCIsig9Hapto.mat','pCIsig9')
% save('pHats6Hapto.mat','pHats6')
% save('pCImu6Hapto.mat','pCImu6')
% save('pCIsig6Hapto.mat','pCIsig6')
save('pHats11Hapto.mat','pHats11')
save('pCImu11Hapto.mat','pCImu11')
save('pCIsig11Hapto.mat','pCIsig11')
save('pHats12Hapto.mat','pHats12')
save('pCImu12Hapto.mat','pCImu12')
save('pCIsig12Hapto.mat','pCIsig12')
end
