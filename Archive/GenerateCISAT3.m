...
function yy = paramfun1(p,t)
    ...
    lambda1=(1/11.8)*p(end-3);
    
    
        lambda2 = (1/11.8)*dd(length(xfitsC(index,:)));
...
if index == 9
    params9(count,:) = FittingforCI(dd,index);
...
% end
if index == 11
    params11(count,:) = FittingforCI(dd,index);
...
if index == 12
    params12(count,:) = FittingforCI(dd,index);
...
SAT3means(count,:) = (params9(count,:)+params11(count,:)+params12(count,:))./3;
SAT3devs(count,:) = std([params9(count,:);  params11(count,:); params12(count,:)]);
...
save('Fits9.mat','Fits9')
% save('Fits10.mat','Fits10')
save('Fits11.mat','Fits11')
save('Fits12.mat','Fits12')

save('params9.mat','params9')
% save('params10.mat','params10')
save('params11.mat','params11')
save('params12.mat','params12')
...
save('SData9.mat','SData9')
%save('SData10.mat','SData10')
save('SData11.mat','SData11')
save('SData12.mat','SData12')
save('SAT3means.mat','SAT3means')
save('SAT3devs.mat','SAT3devs')
save('pHats9.mat','pHats9')
save('pCImu9.mat','pCImu9')
save('pCIsig9.mat','pCIsig9')
% save('pHats10.mat','pHats10')
%save('pCImu10.mat','pCImu10')
%save('pCIsig10.mat','pCIsig10')
save('pHats11.mat','pHats11')
save('pCImu11.mat','pCImu11')
save('pCIsig11.mat','pCIsig11')
save('pHats12.mat','pHats12')
save('pCImu12.mat','pCImu12')
save('pCIsig12.mat','pCIsig12')
end
