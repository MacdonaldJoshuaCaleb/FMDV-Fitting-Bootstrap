...
load('params1.mat');
load('params2.mat');   load('SData1.mat')
SynDataX = SData1(:,1:7);
SynDataS = SData1(:,8:14);
SynDataPV = SData1(:,15:end);
load('params4.mat');
...
for j = 1:10000
 RE1(j,:) = abs(params(1,:)-params1(j,:))./params(1,:);
end
ARE1 = (sum(RE1)/10000)*100;
array2table(ARE1)

for j = 1:10000
 RE2(j,:) = abs(params(2,:)-params2(j,:))./params(2,:);
end
ARE2= (sum(RE2)/10000)*100;
array2table(ARE2)

for j = 1:10000
 RE3(j,:) = abs(params(3,:)-params3(j,:))./params(3,:);
end
ARE3= (sum(RE3)/10000)*100;
array2table(ARE3)

for j = 1:10000
 RE4(j,:) = abs(params(4,:)-params4(j,:))./params(4,:);
end
