...
set(h3,'facealpha',.4)
plot(t,xsC(5,:),'b*',t,sesC(5,:),'r+',t,pvsC(5,:),'go','MarkerSize',20,'linewidth',2)
...
h3 = fill(x2, inBetween3,'g','LineStyle','none');
set(h3,'facealpha',.4)
plot(t,xsC(6,:),'b*',t,sesC(6,:),'r+',t,pvsC(6,:),'go','MarkerSize',20,'linewidth',2)
plot(ttt,yy(:,1),'b',ttt,yy(:,2),'r',ttt,yy(:,3),'g','linewidth',2)
title('ID9, SAT2')
hold off
ylim([0 14])
...
h3 = fill(x2, inBetween3,'g','LineStyle','none');
set(h3,'facealpha',.4)
plot(t,xsC(7,:),'b*',t,sesC(7,:),'r+',t,pvsC(7,:),'go','MarkerSize',20,'linewidth',2)
plot(ttt,yy(:,1),'b',ttt,yy(:,2),'r',ttt,yy(:,3),'g','linewidth',2)
title('ID22, SAT2')
hold off
ylim([0 14])
...
for j = 1:10000
 RE5(j,:) = abs(params(5,1:end-1)-params5(j,:))./params(5,1:end-1);
end
ARE5 = (sum(RE5)/10000)*100;
array2table(ARE5)

for j = 1:10000
 RE6(j,:) = abs(params(6,1:end-1)-params6(j,:))./params(6,1:end-1);
end
ARE6= (sum(RE6)/10000)*100;
array2table(ARE6)

for j = 1:10000
 RE7(j,:) = abs(params(7,1:end-1)-params7(j,:))./params(7,1:end-1);
end
ARE7= (sum(RE7)/10000)*100;
array2table(ARE7)
