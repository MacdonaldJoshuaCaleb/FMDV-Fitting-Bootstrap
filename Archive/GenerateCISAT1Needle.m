...
if index == 1
    params1(count,:) = FittingforCINeedle(dd,index);
...
if index == 2
    params2(count,:) = FittingforCINeedle(dd,index);
...
if index == 3
    params3(count,:) = FittingforCINeedle(dd,index);
...
if index == 4
    params4(count,:) = FittingforCINeedle(dd,index);
...
save('Fits1Needle.mat','Fits1')
save('Fits2Needle.mat','Fits2')
save('Fits3Needle.mat','Fits3')
save('Fits4Needle.mat','Fits4')

save('params1Needle.mat','params1')
save('params2Needle.mat','params2')
save('params3Needle.mat','params3')
save('params4Needle.mat','params4')
...
save('SData1Needle.mat','SData1')
save('SData2Needle.mat','SData2')
save('SData3Needle.mat','SData3')
save('SData4Needle.mat','SData4')
save('SAT1meansNeedle.mat','SAT1means')
save('SAT1devsNeedle.mat','SAT1devs')
save('pHats1Needle.mat','pHats1')
save('pCImu1Needle.mat','pCImu1')
save('pCIsig1Needle.mat','pCIsig1')
save('pHats2Needle.mat','pHats2')
save('pCImu2Needle.mat','pCImu2')
save('pCIsig2Needle.mat','pCIsig2')
save('pHats3Needle.mat','pHats3')
save('pCImu3Needle.mat','pCImu3')
save('pCIsig3Needle.mat','pCIsig3')
save('pHats4Needle.mat','pHats4')
save('pCImu4Needle.mat','pCImu4')
save('pCIsig4Needle.mat','pCIsig4')
end
